...
**代码：**
```Java
void si_sort(int[] arr, Comparator<? super Integer> comparator){
    int _len = arr.length;
...
```Java
void shellsort(int[] arr, Comparator<? super Integer> comparator){
      int _len = arr.length;
...
**代码：**
```Java
 void buildHeap(int[] arr, int end, Comparator<? super Integer> comparator){
     for (int i = end; i > 0; i--) {
         int parent = (i-1) / 2;
         int cur = i;
 ...
 void heapSort(int[] arr, Comparator<? super Integer> comparator){
...
int splitArray(int[] arr,int start,int end, Comparator<? super Integer> comparator){
...
void queckSort(int[] arr, int start, int end, Comparator<? super Integer> comparator){
    if(start >= end)return;
